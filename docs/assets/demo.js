...
var allCountries = [ // Taken from https://gist.github.com/unceus/6501985
...
function demoController($scope, $http, $timeout, $interval) {
  var vm = this;
  ...
  vm.refreshAddresses = function(address) {
    ...
    // });
    vm.addresses = allCountries.map(x => ({ ...x, formatted_address: x.name, selected: { formatted_address: 'fdsafs' } }));
  };
...
app.controller('DemoCtrl', demoController);
